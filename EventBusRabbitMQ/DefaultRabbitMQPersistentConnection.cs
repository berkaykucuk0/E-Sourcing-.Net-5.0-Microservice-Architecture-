...
namespace EventBusRabbitMQ
{
    public class DefaultRabbitMQPersistentConnection : IRabbitMQPersistentConnection
    {
        ...
        public bool TryConnect()
        {
            ...
            //Hala işlemler başarılı değilse tekrar eventlerle deneme yapıyoruz
            if (IsConnected)
            {
        ...
        //Bağlantılarda hata oluşursa bu eventler ile tekrar bağlantı atıyoruz
        ...
        //QUEUE Management işlemlerini yapan sınıf IModel sınıfındadır
